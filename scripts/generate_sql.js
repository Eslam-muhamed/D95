...
for (const product of products) {
    ...
    sql += `UPDATE products SET description = '${safeDescription}', image_url = '${image_url}' WHERE id = '${product.id}';\n`;
}

fs.writeFileSync('update_products.sql', sql);
console.log('Generated update_products.sql');
