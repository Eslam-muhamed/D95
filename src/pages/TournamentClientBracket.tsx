                        ...
                        <div key={round} className="w-[280px] flex flex-col gap-6 justify-around">
                            ...
                            <div className="flex flex-col gap-8 justify-center flex-1">
                                {roundMatches.map(match => (
                                    <div key={match.id} className="relative bg-white dark:bg-[#150f11] border border-neutral-200 dark:border-white/10 rounded-xl shadow-sm overflow-hidden flex flex-col min-h-[90px]">
                                        ...
                                        {rIdx < rounds.length - 1 && (
                                            <div className="absolute -left-6 top-1/2 -translate-y-1/2 w-6 border-b-2 border-neutral-200 dark:border-white/10 hidden md:block" />
                                        )}
                                    </div>
                                ))}
                            </div>
